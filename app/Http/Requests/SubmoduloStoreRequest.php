...
class SubmoduloStoreRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => ['required', 'min:3', 'unique:submodulos'],
            'menu_text' => ['required', 'min:3', 'unique:submodulos'],
            'menu_url' => ['required', 'min:3', 'unique:submodulos'],
            'menu_route' => ['required', 'min:3', 'unique:submodulos'],
            'menu_icon' => ['required', 'min:3', 'unique:submodulos'],
            'prefix_permissao' => ['required', 'min:3', 'unique:submodulos'],
            'prefix_route' => ['required', 'min:3', 'unique:submodulos'],
