...
class ProfessorStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'pai' => ['nullable', 'min:3'],
            'mae' => ['nullable', 'min:3'],
            'email' => ['nullable', 'unique:professores', 'email'],
            ...
            'cpf' => ['required', 'unique:professores', 'cpf'],
            'pis' => ['nullable', 'unique:professores', 'nis'],
            'pasep' => ['nullable', 'unique:professores', 'nis'],
            'carteira_trabalho' => ['nullable', 'unique:professores', 'numeric'],
